...
class SignupPage extends React.Component {
    ...
    renderFreeTrialMessage() {
        ...
        if (hasFreeTrialTier({site})) {
            return (
                <p className='gh-portal-free-trial-notification'>Después de que finalice la prueba gratuita, se te cobrará el precio regular del plan que has elegido. Siempre puedes cancelar antes.</p>
            );
        }
        return null;
    }
            ...
            return (
                <section>
                    <div className='gh-portal-section'>
                        <p className='gh-portal-invite-only-notification'>Este sitio es solo por invitación, contacta con el propietario para conseguir acceso.</p>
