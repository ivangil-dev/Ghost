...
export default class OfferPage extends React.Component {
    ...
    renderSubmitButton() {
        ...
        if (offer.type === 'trial') {
            label = 'Empezar con ' + offer.amount + ' días de prueba gratuita';
        }
    ...
    renderOfferMessage({offer, product, price}) {
        ...
        if (discountDuration === 'trial') {
            return (
                <p className="footnote">Prueba gratis durante {offer.amount} días, luego {originalPrice}. <span class="gh-portal-cancel">Cancela cuando quieras.</span></p>
            );
        }
        return (
