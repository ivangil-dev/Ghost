            ...
            getText(url, type, email) {
                ...
                case 'signup':
                    return `
                        ...
                        Por tu seguridad, este enlace será eliminado en 24 horas y nunca más funcionará.
                ...
                case 'signup-paid':
                    return `
                        ...
                        Enviado a ${email}
                        Gracias por suscribirte a ${siteTitle}!
                    `;
                case 'updateEmail':
                    return `
                        ¡Hola!,
                ...
                default:
                    return `
                        ...
                        Hola de nuevo! Usa este enlace para iniciar sesión de forma segura y sin contraseña en tu cuenta de ${siteTitle}:
                        ${url}
